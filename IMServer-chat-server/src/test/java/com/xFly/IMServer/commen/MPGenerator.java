...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        //todo 要改输出路径
        globalConfig.setOutputDir(System.getProperty("user.dir") + "/IMServer-learning/IMServer-chat-server/src/main/java");
        //设置作者名字
        globalConfig.setAuthor("<a href=\"https://github.com/T1uck\">xFly</a>");
        ...
        packageConfig.setParent("com.xFly.IMServer.common.user");//自定义包的路径
        packageConfig.setEntity("domain.entity");
        packageConfig.setMapper("mapper.user");
